...
# loading the data
ap = pd.read_csv("E:/Data Science 18012022/Multiple linear Regression/Avacado_Price.csv")
ap.columns
...
plt.bar(height = ap["XLarge Bags"], x = np.arange(1, 18250, 1))
...
sns.jointplot(x=ap['XLarge Bags'], y=ap['AveragePrice'])
